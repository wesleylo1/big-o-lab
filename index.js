...
// ANSWER: No, since it's already a constant
...
// ANSWER:  first function has a single loop using the .forEach() method, and the second function has a single for loop. They're also both independent of the string.
